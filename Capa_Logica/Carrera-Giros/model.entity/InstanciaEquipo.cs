...
namespace model.entity
{
    public class InstanciaEquipo
    {
        ...
        public InstanciaEquipo() { }

        public InstanciaEquipo(int pInstanciaEquipo)
        {
            this.id = pInstanciaEquipo;
        }

        //Creamos un constructor con la llave primaria.
        public InstanciaEquipo(int pInstanciaEquipo, int idInstanciaGiroPorEquipo, int id, int idCorredor, string nombreCorredor, string nombreEquipo, string tiempoTotal, int sumaPuntosMontana, int sumaPuntosRegulares, string nombreGiro, int numeroCamisa, int anio)
        {
            this.id = pInstanciaEquipo;
